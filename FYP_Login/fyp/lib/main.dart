  ...
  if (kIsWeb) {
    await Firebase.initializeApp(
      options: FirebaseOptions(
        apiKey: "AIzaSyCAAsIbQ4xDIWA7KXmDdvi4nDeQSD0kNEk",
        appId: "1:301192996255:web:cc66b6eff7f79b7a1cc9aa",
        messagingSenderId: "301192996255",
        projectId: "fyp-firebase-setup",
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        // '/tripHistory': (context) => TripHistoryPage(tripName: "Sample Trip"),
      },
    );
  }
}
